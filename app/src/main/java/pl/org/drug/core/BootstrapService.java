...
import static pl.org.drug.core.Constants.Http.HEADER_PARSE_APP_ID;
import static pl.org.drug.core.Constants.Http.HEADER_PARSE_REST_API_KEY;
import static pl.org.drug.core.Constants.Http.PARSE_APP_ID;
import static pl.org.drug.core.Constants.Http.PARSE_REST_API_KEY;
import static pl.org.drug.core.Constants.Http.URL_CHECKINS;
...
public class BootstrapService {
    ...
    private static class DrugEventWrapper {
      private List<DrugEvent> events;
    }
     ...
     * @throws IOException
     */
    public List<DrugEvent> getCheckIns() throws IOException {
        try {
            HttpRequest request = execute(HttpRequest.get(URL_EVENTS));
            DrugEventWrapper response = fromJson(request, DrugEventWrapper.class);
