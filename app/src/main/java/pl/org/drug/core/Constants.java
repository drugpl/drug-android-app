...
public class Constants {
    ...
    public static class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "pl.org.drug";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "DRUG";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "pl.org.drug.sync";
    ...
    public static class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "pl.org.drug.";
